...
public class MainActivity extends Activity {
	...
	private class TareaWSConsulta extends AsyncTask<String,Integer,Boolean> {
	    ...
	    protected Boolean doInBackground(String... params) {
	    	...
	    	final String NAMESPACE = "http://cljmunoz.ddns.net/";
			final String URL="http://cljmunoz.ddns.net/servicioClientes.asmx";
			final String METHOD_NAME = "ListadoClientes";
			final String SOAP_ACTION = "http://cljmunoz.ddns.net/ListadoClientes";
	...
	private class TareaWSInsercion1 extends AsyncTask<String,Integer,Boolean> {
	    ...
	    protected Boolean doInBackground(String... params) {
			...
			final String SOAP_ACTION = "http://cljmunoz.ddns.net/NuevoClienteSimple";
	...
	private class TareaWSInsercion2 extends AsyncTask<String,Integer,Boolean> {
	    ...
	    protected Boolean doInBackground(String... params) {
			...
			final String SOAP_ACTION = "http://cljmunoz.ddns.net/NuevoClienteObjeto";
